...
will probably want to have the same settings for USB and LSB. Therefore,
 ...
 or equaliser settings for the active receiver when running USB,
...
To make the communication work, the easiest work-araound is probably to assign a fixed IP address both to

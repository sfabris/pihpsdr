...
\item{Extended the RX and TX equalisers to 10 bands (\bltt{Equalizer} menu)}
...
won't reply to ``routed'' discovery packets. The radios I have tested (ANAN-7000, RedPitaya STEMlab, HermesLite-II) all
allow being discovered by such non-broadcast packets, so using the IP address might become a

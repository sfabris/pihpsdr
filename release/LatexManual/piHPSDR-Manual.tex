...
signal should only have two peaks! The reason is, that the TX spectrum scope
...
This is a rather clean two-tone signal (no satellites can be seen,
...
grow out of the dust and rise to
about 30 dBc, which reflects the non-linearity of the PA. Note that this is quite a typical
values. Unless you have a class-A amplifier, your PA probably won't be much better.
...
\action{Rcl 1}{RCL1}{B}{Recall (restore) data from the memory slot 1 (see the \bltt{Memory} menu, Chapter \ref{sec:memmenu}).}

\action{Rcl 2}{RCL2}{B}{Recall (restore) data from the memory slot 2 (see the \bltt{Memory} menu, Chapter \ref{sec:memmenu}).}

\action{Rcl 3}{RCL3}{B}{Recall (restore) data from the memory slot 3 (see the \bltt{Memory} menu, Chapter \ref{sec:memmenu}).}

\action{Rcl 4}{RCL4}{B}{Recall (restore) data from the memory slot 4 (see the \bltt{Memory} menu, Chapter \ref{sec:memmenu}).}

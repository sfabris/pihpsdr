...
In rare cases (the STEMLAB case is the only one I know of) it is even possible to use the TCP protocol
rather than the standard UDP one for communicating with the radio. A ``TCP discovery'' will take three
seconds if there is just no response, which should be the case for most radios. Therefore, trying to
...
network segment. This behaviour enables very fast program startup e.g. for HermesLite-II radios, but
make sure the \rett{Enable TCP} box is \textit{not} checked.
...
is transferred. If not using duplex, no RX audio data is transferred when TXing.
...
TX if doing SSB. When TXing in CW, very little data (the CW key-down/up time stamps) is actually sent.
...
(that is, for the baseband IQ data) were not entirely successful.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
